  ...
  async up (queryInterface, Sequelize) {
    try {
      await queryInterface.bulkInsert('articles', [{
        ...
        views: 22,
        tags: JSON.stringify(["Javascript"]), // Ensure tags are serialized as JSON
        type: JSON.stringify(["IT"]), // Ensure type is serialized as JSON
        // image: "https://teknotower.com/wp-content/uploads/2020/11/js.png",
        blocks: JSON.stringify([ // Serialize the blocks array as JSON
          {
            "type": "image",
          ...
          {
            "type": "list",
            "list": ["Это позволяет загружать модули динамически"]
          },
          {
            "type": "code",
            "language": "JavaScript",
          ...
          {
            "type": "list",
            "list": ["Это позволяет загружать модули условно"]
          },
          {
            "type": "code",
            "language": "JavaScript",
